...
> ⚠️ **УСТАРЕЛО (2026-06-10).** Этот документ описывает **первый, отозванный**
> деплой `0x00dD1EE8dC51B8Fb704487feBa103cf782c6AB12` со шкалой 0..1000.
> Актуальный контракт — **`0x1894Be93D9ACA27b7A6AF0eaD56354D9EbA0Ffb9`**
> (шкала 0..100, Sourcify exact match). См. [`contracts/README.md`](../../contracts/README.md)
> и корневой [`README.md`](../../README.md). Адреса/ссылки ниже не использовать.
